interface TengeIconProps {
    className?: string;
    color?: string;
}

export const TengeIcon = ({ className, color }: TengeIconProps) => {
    return (
        <svg
